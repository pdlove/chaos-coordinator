...
public class UploadsController(IWebHostEnvironment env) : ControllerBase
{
    ...
    /// <summary>Used both by the phone chore-detail "photo evidence" flow and the wall display's
    /// full-screen camera capture — both just POST a captured image and get a URL back to attach
    /// to a ChoreCompletion.</summary>
