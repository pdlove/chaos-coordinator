...
public static class DbSeeder
{
    public static async Task SeedAsync(AppDbContext db)
    {
        ...
        var carmen = new User { Id = Guid.NewGuid(), HouseholdId = household.Id, Name = "Carmen", Initials = "CL", Color = "#FF6B57", Role = Role.Adult, Order = 0, PinHash = BCrypt.Net.BCrypt.HashPassword("1234") };
        var paul = new User { Id = Guid.NewGuid(), HouseholdId = household.Id, Name = "Paul", Initials = "PL", Color = "#4C8BF5", Role = Role.Adult, Order = 1, PinHash = BCrypt.Net.BCrypt.HashPassword("5678") };
        ...
        var tina = new User { Id = Guid.NewGuid(), HouseholdId = household.Id, Name = "Tina", Initials = "TM", Color = "#9B6BD9", Role = Role.Other, Order = 4, PinHash = BCrypt.Net.BCrypt.HashPassword("3333") };
